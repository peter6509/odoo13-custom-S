...
class Reportequipstatusbarcode(models.AbstractModel):
    _name = 'report.alldo_gh_iot.alldo_gh_iot_equipstatusbarcode_report'

    @api.model
    def _get_report_values(self, docids, data=None):
        docs = self.env['alldo_gh_iot.equipstatusinfo'].search([])
        # print(docs)
        res_doc = []
        barcode_doc = []
        for line1 in docs:
        ...
        docargs = {
            ...
            'doc_ids': docids,
            'doc_model': 'alldo_gh_iot.equipstatusinfo',
            'docs': res_doc,
        }
        return docargs
