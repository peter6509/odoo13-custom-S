...
class ghiotrestartwizard(models.TransientModel):
    _name = "alldo_gh_iot.iot_restart_wizard"

    equipment_ids = fields.Many2many('maintenance.equipment','gh_iot_restart_equipment_rel', 'wizard_id',
