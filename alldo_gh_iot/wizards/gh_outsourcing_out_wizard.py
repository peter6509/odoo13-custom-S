...
class ghoutsourcingoutwizard(models.TransientModel):
    _name = "alldo_gh_iot.outsourcing_out"
    ...
    def onchangclient(self):
        myrec = self.env['alldo_gh_iot.outsuborder'].search([('id','=',self.suborder_id.id)])
