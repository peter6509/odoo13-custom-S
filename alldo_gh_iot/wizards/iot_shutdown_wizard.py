...
class ghiotshutdownwizard(models.TransientModel):
    _name = "alldo_gh_iot.iot_shutdown_wizard"

    equipment_ids = fields.Many2many('maintenance.equipment','gh_iot_shutdown_equipment_rel', 'wizard_id',
