...
class alldoghiotserverinfo(models.Model):
    _name = "alldo_gh_iot.server_info"
    ...
    def create(self, vals_list):
        ...
        res = super(alldoghiotserverinfo, self).create(vals_list)
        mynum = self.env['alldo_gh_iot.server_info'].search_count([])
        if mynum > 1:
