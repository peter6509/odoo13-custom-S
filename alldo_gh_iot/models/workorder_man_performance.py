...
class workordermanperformance(models.Model):
    _name = "alldo_gh_iot.man_performance"

    order_id = fields.Many2one('alldo_gh_iot.workorder',string="工單號碼")
...
class wkorderequipperformance(models.Model):
    _name = "alldo_gh_iot.equipment_performance"
...
class workordermanperformancelist(models.Model):
    _name = "alldo_gh_iot.man_performance_list"
    _order = "prod_owner"
...
class equipmentperformancelist(models.Model):
    _name = "alldo_gh_iot.equipment_performance_list"
    _description = "機台稼動時間"
    _order = "equip_no"
...
class workordermanperformancetrmp(models.Model):
    _name = "alldo_gh_iot.man_performance_temp"
