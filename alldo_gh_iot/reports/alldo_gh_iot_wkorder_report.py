...
class ReportSaleOrder(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        # print(docids)
        self.env.cr.execute("""delete from alldo_gh_iot_wkorder_selectitem""")
        ...
        self.env.cr.execute("""commit""")
        docs = self.env['alldo_gh_iot.wkorder_printsheet'].search([])
        #print(docs)
        res_doc = []
        for line in docs:
            ...
            temp = {
                ...
                'ins1correctno': line.correct_no1,
                'ins1toolname': line.inspect_tool1.name,
                'ins1toolcode':line.inspect_tool1.inspect_code,
                'ins1point':line.inspect1_point,
                ...
                'ins2correctno': line.correct_no2,
                'ins2toolname': line.inspect_tool2.name,
                'ins2toolcode': line.inspect_tool2.inspect_code,
                'ins2point': line.inspect2_point,
                ...
                'ins3correctno': line.correct_no3,
                'ins3toolname': line.inspect_tool3.name,
                'ins3toolcode': line.inspect_tool3.inspect_code,
                'ins3point': line.inspect3_point,
                ...
                'ins4correctno': line.correct_no4,
                'ins4toolname': line.inspect_tool4.name,
                'ins4toolcode': line.inspect_tool4.inspect_code,
                'ins4point': line.inspect4_point,
                ...
                'ins5correctno': line.correct_no5,
                'ins5toolname': line.inspect_tool5.name,
                'ins5toolcode': line.inspect_tool5.inspect_code,
                'ins5point': line.inspect5_point,
