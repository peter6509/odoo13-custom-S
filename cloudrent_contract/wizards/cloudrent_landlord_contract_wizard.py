...
class cloudrentLandlordContractWizard(models.TransientModel):
    _name = "cloudrent.landlord_contract_wizard"
    ...
    def run_landlord_contract_gen(self):
        ...
        myrec=self.env['cloudrent.landlord_contract']
        ...
        myviewid = self.env.ref('cloudrent_contract.view_landlord_contract_form')
        return {
            'view_type': 'form',
            'view_mode': 'form',
            'res_model': 'cloudrent.landlord_contract',
