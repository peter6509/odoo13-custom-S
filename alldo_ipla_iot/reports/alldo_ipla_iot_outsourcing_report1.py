...
class Reportoutsourcingreport1(models.AbstractModel):
    _name = 'report.alldo_ipla_iot.outsourcing_report1'

    @api.model
    def _get_report_values(self, docids, data=None):
        res_doc = []
        outsourcing_doc = []
        docs=self.env['alldo_ipla_iot.outsuborder'].search([('id','in',docids)])
        ...
        docargs = {
            'doc_ids': docids,
            'doc_model': 'alldo_ipla_iot.outsuborder',
            'docs': res_doc,
        }
        return docargs
