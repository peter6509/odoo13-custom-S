...
class iplaaccountmovewizard(models.TransientModel):
    _name = "alldo_ipla_iot.accountmove_wizard"
    ...
    def run_accountmove(self):
        ...
        myrec = self.env['alldo_ipla_iot.accountmove_selectitem'].search([])
        myid = myrec[0].id
        return {'view_name': 'views_accountmove_selectitem_action',
                'name': (u'Account Move Data'),
                'views': [[False, 'form']],
                'res_model': 'alldo_ipla_iot.accountmove_selectitem',
