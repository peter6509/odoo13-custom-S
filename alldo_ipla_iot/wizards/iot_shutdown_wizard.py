...
class iplaiotshutdownwizard(models.TransientModel):
    _name = "alldo_ipla_iot.iot_shutdown_wizard"
    _description = "IOT裝置主控關鍵精靈"

    equipment_ids = fields.Many2many('maintenance.equipment','ipla_iot_shutdown_equipment_rel', 'wizard_id',
