...
class iplamixsearchscalemovelist(models.Model):
    _name = "alldo_ipla_iot.mixsearch_scalemovelist"

    scale_type = fields.Selection([('1', '生產機台投料'), ('2', '回收料入庫')], string="類別", default='1')
    ...
    equipment_no = fields.Many2one('maintenance.equipment', string="機台設備")
