...
class alldoiplaiotserverinfo(models.Model):
    _name = "alldo_ipla_iot.server_info"
    ...
    def create(self, vals_list):
        ...
        res = super(alldoiplaiotserverinfo, self).create(vals_list)
        mynum = self.env['alldo_ipla_iot.server_info'].search_count([])
        if mynum > 1:
