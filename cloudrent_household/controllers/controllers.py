...
class LineNotifyRoute(http.Controller):
    ...
    def line_access_token(self, **kw):
        ...
        line_configure = request.env['cloudrent.line_notify_configure'].search([('active', '=', True), ('test_mode', '=', False)])
        member_id = request.env['cloudrent.household_member'].search([('state_code', '=', state)])
        ...
        if token_check.status_code == 200:
            ...
            print(token_code)
            member_id.write({'line_access_token': token_code})
