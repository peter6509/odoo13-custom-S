...
class cloudrenthouseholduncompletewizard(models.TransientModel):
    _name = "cloudrent.previous_balance_wizard"
    ...
    def _get_uncomplete(self):
        ...
        if self.payment_ym:
            ...
            myym = myy + '-' + mym
            myrec = self.env['cloudrent.household_payment_line'].search(
