...
class cloudrent_mmonth_report(models.AbstractModel):
    _name = "report.cloudrent_household.mmonth_report"
    ...
    def _get_report_values(self, docids, data):
        ...
        cloudrent_month_data = self.env['cloudrent.household_house_line'].search(domain)


        mydata = cloudrent_month_data.sorted(key=lambda r: r.house_no)
        myprojectno=''
        mybillym=''
        if myres:
