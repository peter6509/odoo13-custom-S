...
class Reportngreturnreport(models.AbstractModel):
    _name = 'report.alldo_acme_iot.ngreturn_report'

    @api.model
    def _get_report_values(self, docids, data=None):
        docs = self.env['alldo_acme_iot.ngreturn_report'].search([])
        # print(docs)
        res_doc = []
        ngreturn_doc = []
        for line1 in docs:
            for line in line1.report_line:
                ...
                acmeaddress = '桃園市楊梅區行善路32巷16號'
                acmetel = '03-4757712'
                acmefax = '03-4757701'
                acmememo = line1.report_memo
        ...
        docargs = {
            'doc_ids': docids,
            'doc_model': 'alldo_acme_iot.ngreturn_report',
            'docs': res_doc,
        }
        return docargs
