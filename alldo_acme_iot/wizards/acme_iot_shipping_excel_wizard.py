...
class acmeiotshippingexcelwizard(models.TransientModel):
    _name = "alldo_acme_iot.shipping_excel_wizard"
    ...
    def run_shipping_excel(self):
        ...
        myshippingrec = self.env['alldo_acme_iot.shipping_list'].search([])
        mycount = self.env['alldo_acme_iot.shipping_list'].search_count([])
        output = io.BytesIO()
