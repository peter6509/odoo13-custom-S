...
class acmeiotrestartwizard(models.TransientModel):
    _name = "alldo_acme_iot.iot_restart_wizard"
    _description = "IOT裝置主控重啟精靈"

    equipment_ids = fields.Many2many('maintenance.equipment','acme_iot_restart_equipment_rel', 'wizard_id',
