...
class wkorderequipperformance(models.Model):
    _name = "alldo_acme_iot.equipment_performance"
...
class workordermanperformancelist(models.Model):
    _name = "alldo_acme_iot.man_performance_list"
    _order = "prod_owner"
...
class equipmentperformancelist(models.Model):
    _name = "alldo_acme_iot.equipment_performance_list"
    _description = "機台稼動時間"
    _order = "equip_no"
...
class workordermanperformancetrmp(models.Model):
    _name = "alldo_acme_iot.man_performance_temp"
