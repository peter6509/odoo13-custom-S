...
class acmemaintenanceinherit1(models.Model):
    ...
    status_type = fields.Selection([('1','停線'),('2','換線'),('3','復歸')],string='類別')
...
class alldoacmeiotoutofforderstatus(models.Model):
    _name = "alldo_acme_iot.equipment_outofforder_status"
