...
class acmeiotworkorderperformance(models.Model):
    _name = "alldo_acme_iot.workorder_performance_list"

    order_id = fields.Many2one('alldo_acme_iot.workorder',string="工單")
...
class acmeiotworkorderperformance1(models.Model):
    _name = "alldo_acme_iot.workorder_performance_list1"
