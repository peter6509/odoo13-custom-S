...
class newebdevexportjdwwizard(models.TransientModel):
    ...
    def run_dev_export(self):
        ...
        titles1 = ['設備名稱', '設備編號', '廠牌','櫃位','負責部門','啟用狀態','客戶類型(個人/公司)','客戶編號','工程師','SLA規範','合約啟始日','合約終止日','服務時段','負責工程師','定期維護條款','維修技能','設備安裝地點','備註','合約編號']
        ...
        for line in mydev_rec:
            ...
            ws1.write(row, 17, line.memo if line.memo else ' ', okl_content_format)
