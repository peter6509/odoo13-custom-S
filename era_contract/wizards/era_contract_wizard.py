...
class EraContractWizard(models.TransientModel):
    _name = "era.contract_wizard"
    ...
    def run_contract_gen(self):
        ...
        myviewid = self.env.ref('era_contract.view_contract_form')
        return {
            'view_type': 'form',
            'view_mode': 'form',
            'res_model': 'era.contract',
