...
class era_maintenance_report(models.AbstractModel):
    _name = "report.era_household.maintenance_report"
    ...
    def _get_report_values(self, docids, data):
        ...
        data_array = []
        era_maintenance_data = self.env['era.household_maintenance'].search(domain)

        mydata = era_maintenance_data.sorted(key=lambda r: (r.main_require_date,r.main_house_id))
