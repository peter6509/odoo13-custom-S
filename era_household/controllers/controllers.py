...
class LineNotifyRoute(http.Controller):
    ...
    def line_access_token(self, **kw):
        ...
        line_configure = request.env['era.line_notify_configure'].search([('active', '=', True), ('test_mode', '=', False)])
        member_id = request.env['era.household_member'].search([('state_code', '=', state)])
