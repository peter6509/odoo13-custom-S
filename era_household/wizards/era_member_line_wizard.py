...
class eramemberlinewizard(models.TransientModel):
    _name = "era_household.member_line_wizard"
    ...
    project_no = fields.Many2one('era.household_house',string="專案名稱",required=True)
