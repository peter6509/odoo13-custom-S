...
if today.hour >= 6:
    ...
    time_value = newday.replace(hour=22, minute=0, second=0, microsecond=0)
else:
...
sql = '''
DROP VIEW IF 	EXISTS zimo_auto_view_pcrl_by_day ;--删除视图
CREATE 	OR REPLACE VIEW zimo_auto_view_pcrl_by_day  AS (
	SELECT
