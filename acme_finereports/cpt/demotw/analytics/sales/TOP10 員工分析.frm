...
<Query>
<![CDATA[select distinct a.姓名,round(${e1},2) as 欄位 from 
(SELECT  姓氏||名字 as 姓名,sum(單價*數量*(1-折扣)) as 銷售額
FROM S僱員,S訂單,S訂單明細
where S僱員.僱員ID=S訂單.僱員ID and S訂單.訂單ID=S訂單明細.訂單ID
group by 姓氏||名字
order by sum(單價*數量*(1-折扣)) desc ) as a,
(SELECT  姓氏||名字 as 姓名,sum(單價*數量*(1-折扣)) as 回款額
FROM S僱員,S訂單,S訂單明細
where S僱員.僱員ID=S訂單.僱員ID and S訂單.訂單ID=S訂單明細.訂單ID and s訂單.是否已付='是'
group by 姓氏||名字
order by sum(單價*數量*(1-折扣)) desc ) as b,回款率
where a.姓名=b.姓名 and a.姓名=僱員姓名]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Query>
<![CDATA[SELECT  strftime('%m',S訂單.訂購日期) as 月份,sum(單價*數量*(1-折扣)) as 銷售額
FROM S訂單,S訂單明細,S僱員
where S訂單.僱員ID=S僱員.僱員ID and S訂單.訂單ID=S訂單明細.訂單ID and strftime('%Y',S訂單.訂購日期)='${nian}' and S僱員.姓氏||S僱員.名字='${name}'
group by strftime('%m',S訂單.訂購日期)
]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<CustomDictAttr>
<Dict key="銷售額" value="銷售額"/>
<Dict key="回款額" value="回款額"/>
</CustomDictAttr>
</Dictionary>
<widgetValue>
<O>
...
<ChartSummaryColumn name="欄位" function="com.fr.data.util.function.SumFunction" customName="銷售/回款額"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
...
<CategoryName value="月份"/>
<ChartSummaryColumn name="銷售額" function="com.fr.data.util.function.SumFunction" customName="銷售額"/>
</MoreNameCDDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="true" export="true" fullScreen="true"/>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="僱員姓名" valueName="所佔比" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[ds4]]></Name>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="值段" valueName="單子" function="com.fr.data.util.function.NoneFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[ds5]]></Name>
...
<TemplateIdAttMark TemplateId="d87e0a36-c93f-4ed8-a93f-46734b882536"/>
</TemplateIdAttMark>
</Form>
