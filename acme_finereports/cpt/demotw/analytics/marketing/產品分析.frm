...
<Query>
<![CDATA[SELECT p.*,a.類別名稱 FROM 波士頓 p left join S類別 a on a.類別ID=p.產品類型]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Query>
<![CDATA[SELECT p.*,a.類別名稱,(訂購量+再訂購量)*單價 as 銷售額 FROM s產品 p left join S類別 a on a.類別ID=p.類別ID where a.類別名稱 in ('${a}')
order by (訂購量+再訂購量)*單價 desc limit 5]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Query>
<![CDATA[SELECT '價格區間' as 單價區間,a.單價,(訂購量+再訂購量)*單價 as 銷售額 FROM S產品 a where 單價 >${indexofarray(split(jiage,'-'),1)} and 單價 < ${indexofarray(split(jiage,'-'),2)}]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
</TableDataMap>
...
<WidgetTitle>
<O>
<![CDATA[=\"   產品類別波士頓矩陣分析(聯動)\"]]></O>
<FRFont name=".SF NS Text" style="0" size="80"/>
<Position pos="2"/>
...
<BubbleTableDefinition201109 seriesName="類別名稱" bubbleX="市場增長" bubbleY="銷售增長" bubbleSize="銷售額"/>
</BubbleTableDefinition>
</ChartDefinition>
</Chart>
...
<O t="XMLable" class="com.fr.base.Formula">
<Attributes>
<![CDATA[="   產品類別波士頓矩陣分析(聯動)"]]></Attributes>
</O>
</widgetValue>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="產品名稱" valueName="銷售額" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
<TableData class="com.fr.data.impl.NameTableData">
<Name>
<![CDATA[ds2]]></Name>
...
<BubbleTableDefinition201109 seriesName="單價區間" bubbleX="單價" bubbleY="銷售額" bubbleSize="无"/>
</BubbleTableDefinition>
</ChartDefinition>
</Chart>
<tools hidden="true" sort="false" export="false" fullScreen="false"/>
...
<TemplateIdAttMark TemplateId="3452294a-f21f-4522-b58c-31f543a05e42"/>
</TemplateIdAttMark>
</Form>
