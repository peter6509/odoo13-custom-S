...
<HtmlLabel customText="function(){var points = this.points ; var total = &apos;&lt;div style=&quot;width:100%; background-color:#808080;color:white&quot;&gt;&apos;; total +=&apos;&lt;div align=left style=&quot;font-size:16px&quot;&gt;&apos;+this.name+&apos;&lt;/div&gt;&apos;; for(var i = 0, len = points.length-1; i &lt; len; i++)  {total +=&apos;&lt;div align=left style=&quot;font-size:13px&quot;&gt;●&apos;+points[i].seriesName+&apos;:&apos;+FR.contentFormat(points[i].value, &apos;&apos;)+&apos;&lt;/div&gt;&apos;;}  return total;}" useHtml="true" isCustomWidth="false" isCustomHeight="false" width="50" height="50"/>
</AttrToolTipContent>
<GI>
<AttrBackground>
...
<VanChartMapPlotAttr mapType="area" geourl="assets/map/geographic/world/中國(省級).json" zoomlevel="5" mapmarkertype="0" nullvaluecolor="-3342337"/>
...
<ChartSummaryColumn name="運營費用" function="com.fr.data.util.function.NoneFunction" customName="運營費用"/>
